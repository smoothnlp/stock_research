...
class NewTextRank():
    ...
    #以中心词为核心，以动名动词对为连接点，以训练的词频为参考，进行带权重的排序
    ...
    def NVNPair(self,words = list,target_flag = True):
        ...
        start = 0
        for i in range(len(words)):
            if "n" in words[i][1] and words[i][1] != "vn":
                former = words[i]
                start = i
                break
            elif "v" in words[i][1] and words[i][1] != "vn":
                later = words[i]
                start = i
                break
            elif words[i][1] == "vn":
        ...
        for i in range(start+1,len(words)-1):
            ...
            elif "n" in words[i][1] and later == "" and former != "" and words[i][1] != "vn":
                former = words[i] 
            elif "v" in words[i][1] and former != "" and later == "" and words[i+1][0] != "的" and words[i][1] != "vn":
                NVwords[(former,words[i])] += 1
                former = ""
                later = words[i]
            elif words[i][1] == "vn" and former != "" and later == "" and words[i+1][0] != "的":
                NVwords[(former,words[i])] += 1
                former = ""
                later = words[i]
            elif "v" in words[i][1] and former == "" and later != "" and words[i][1] != "vn":
                later = words[i]
            elif words[i][1] == "vn" and former == "" and later != "":
                later = words[i]
            elif "w" in words[i][1]:
                former = ""
                later = ""
